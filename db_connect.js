...
exports.retrievePosts = function retrievePosts(locker_id) {
    var id_lists;
...
exports.storePostId = function storePostId(post_id, live_id) {
...
exports.storeLiveId = function storeLiveId(live_id) {
